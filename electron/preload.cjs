...
contextBridge.exposeInMainWorld("SBP", {
  db: {
    ...
    updateDrawingSetStatus: (id, newStatus, userId) => ipcRenderer.invoke("db:updateDrawingSetStatus", id, newStatus, userId),
    deleteDrawingSet: (id, userId) => ipcRenderer.invoke("db:deleteDrawingSet", id, userId),
